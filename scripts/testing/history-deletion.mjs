...
const scriptPaths = [
  ...
  ["extansion", "background", "tracking", "graph", "model", "normalize", "messages.js"],
  ["extansion", "background", "tracking", "graph", "model", "normalize", "startup.js"],
  ["extansion", "background", "tracking", "graph", "model", "edge-stats.js"],
  ["extansion", "background", "tracking", "graph", "events", "transitions.js"],
  ["extansion", "background", "tracking", "graph", "model", "normalize", "graph.js"],
  ["extansion", "background", "tracking", "graph", "indexes", "transitions", "buckets.js"],
