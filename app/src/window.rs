...
pub fn list_chrome_windows() -> Vec<ChromeWindowInfo> {
    enumerate::enumerate_chrome_windows()
}

pub fn request_hide_chrome_window(request: &HideWindowRequest) -> HideWindowResponse {
    manager::hide_chrome_window(request)
}
