...
![Chrome ????????????????](assets/chrome-web-store/out/ja/small-tile.png)

![Chrome ????????????????](assets/chrome-web-store/out/ja/marquee.png)

![Chrome ????????????????? 1](assets/chrome-web-store/out/ja/screenshot-1.png)

![Chrome ????????????????? 2](assets/chrome-web-store/out/ja/screenshot-2.png)

![Chrome ????????????????? 3](assets/chrome-web-store/out/ja/screenshot-3.png)

![Chrome ????????????????? 4](assets/chrome-web-store/out/ja/screenshot-4.png)

![Chrome ????????????????? 5](assets/chrome-web-store/out/ja/screenshot-5.png)
