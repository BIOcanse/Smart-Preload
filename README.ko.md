...
[GitHub Releases](https://github.com/BIOcanse/Smart-Preload/releases/latest)는 선택 사항인 Windows 연동 앱, 릴리스 노트, 수동 설치 패키지용입니다.
...
일반 사용은 [Chrome 웹 스토어](https://chromewebstore.google.com/detail/smart-preload/poikolgeopfpaoainnakkbjlbmloploc?utm_source=ext_app_menu)에서 확장 프로그램을 설치하세요.

1. Chrome 또는 Edge에 확장 프로그램을 설치합니다.
2. 선택 사항으로 [GitHub Releases](https://github.com/BIOcanse/Smart-Preload/releases/latest)에서 Windows 연동 앱을 다운로드하고 압축 해제합니다.
